...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickb1(View v){
        ...
        t.setGravity(Gravity.CENTER,0,0); //p.220쪽
        t.show();
    }
    public void clickb2(View v){
        ...
        View view = inflater.inflate(R.layout.toast,
                (ViewGroup) findViewById(R.id.toast_layout));   //toast_layout은
    ...
    public void clickb4(View v){
        ...
        builder.setMessage("Do you Exit Now");
    ...
    public void btprogress(View v){
        ...
        if(v.getId() == R.id.button5){
            ...
            if(pdata <10){
                ...
                Toast.makeText(this,"Max Value",Toast.LENGTH_LONG).show();
            }
...
//        super.onBackPressed();
        LayoutInflater inflater = getLayoutInflater();
        View view = inflater.inflate(R.layout.mymy,
                (ViewGroup) findViewById(R.id.mymy));
